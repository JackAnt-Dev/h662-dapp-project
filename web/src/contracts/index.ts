import { AbiItem } from "web3-utils"; // interface(abi)가 정의된 파일. 각각의 타입을 저장하고 있음.
...
const mintAnimalTokenAddress = "0xB5413724a9fCAAC2aA10330Bdc00da4D993d3C5D";
const saleAnimalTokenAddress = "0xD55d90a5b0f4b8a557251Cd8812725759722466A";
